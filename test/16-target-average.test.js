...
describe('Target Average How Exciting!', () => {
	...
	it('Given a range of 2', () => {
		const input = [1, 2, 3, 4, 5, 6, 7];
		const expectedResult = [1, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5]; // how you handle this is up to you
	...
	it('Given a range of 4', () => {
		const input = [1, 2, 3, 4, 5, 6, 7];
		const expectedResult = [1.5, 2, 2.5, 3.5, 4.5, 5.5, 6]; // how you handle this is up to you
